...
eleventyNavigation:
  key: Crystal Word Chain
  parent: project
  order: 2
permalink: /project/crystal-word-chain.html
---
{% section %}
...
<ul>
  <li><a href="/assets/pdfs/crystal-word-chain-full-board-cm.pdf" target="_blank">The Crystal Word Chain Game Board (full board)</a></li>
  <li><a href="/assets/pdfs/crystal-word-chain-small-board-cm.pdf" target="_blank">The Crystal Word Chain Game Board (small board)</a></li>
  <li><a href="/assets/pdfs/crystal-word-chain-seed-words.pdf" target="_blank">The Crystal Word Chain Seed Word Selector</a></li>
</ul>
...
<img src="/assets/images/adobe-reader-tiling.png" width="400">
